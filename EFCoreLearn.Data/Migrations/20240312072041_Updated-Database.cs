    ...
    public partial class UpdatedDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, null, new DateTime(2024, 3, 12, 7, 20, 40, 992, DateTimeKind.Unspecified).AddTicks(6558), 0, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tivoli Gardens F.C.", null },
                    { 2, 0, null, new DateTime(2024, 3, 12, 7, 20, 40, 992, DateTimeKind.Unspecified).AddTicks(6564), 0, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Waterhouse F.C.", null },
                    { 3, 0, null, new DateTime(2024, 3, 12, 7, 20, 40, 992, DateTimeKind.Unspecified).AddTicks(6565), 0, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Humble Lions F.C.", null }
                });
        }
