...
namespace EFCoreLearn.Data.Migrations
{
    ...
    [Migration("20240312074607_AddedConfigurations")]
            ...
            modelBuilder.Entity("EFCoreLearn.Domain.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CoachId = 0,
                            CreatedDate = new DateTime(2024, 3, 12, 7, 46, 7, 519, DateTimeKind.Unspecified).AddTicks(1059),
                            LeagueId = 0,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 2,
                            CoachId = 0,
                            CreatedDate = new DateTime(2024, 3, 12, 7, 46, 7, 519, DateTimeKind.Unspecified).AddTicks(1065),
                            LeagueId = 0,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Waterhouse F.C."
                        },
                        new
                        {
                            Id = 3,
                            CoachId = 0,
                            CreatedDate = new DateTime(2024, 3, 12, 7, 46, 7, 519, DateTimeKind.Unspecified).AddTicks(1066),
                            LeagueId = 0,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
