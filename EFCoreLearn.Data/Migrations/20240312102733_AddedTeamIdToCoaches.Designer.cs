...
namespace EFCoreLearn.Data.Migrations
{
    ...
    [Migration("20240312102733_AddedTeamIdToCoaches")]
            ...
            modelBuilder.Entity("EFCoreLearn.Domain.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CoachId = 0,
                            CreatedDate = new DateTime(2024, 3, 12, 10, 27, 33, 754, DateTimeKind.Unspecified).AddTicks(6746),
                            LeagueId = 0,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 2,
                            CoachId = 0,
                            CreatedDate = new DateTime(2024, 3, 12, 10, 27, 33, 754, DateTimeKind.Unspecified).AddTicks(6752),
                            LeagueId = 0,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Waterhouse F.C."
                        },
                        new
                        {
                            Id = 3,
                            CoachId = 0,
                            CreatedDate = new DateTime(2024, 3, 12, 10, 27, 33, 754, DateTimeKind.Unspecified).AddTicks(6756),
                            LeagueId = 0,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
